...
function preload() {
  ...
  trans1 = loadImage('assets/trans1.png');
  trans2 = loadImage('assets/trans2.png')
...
function draw() {
    ...
    function game(){
            ...
            if (key != "ArrowLeft" && key != "ArrowDown" && key != "ArrowRight" && key != "ArrowUp" && previouskey === "ArrowUp"){
                yplayer-=ys;
            }
            if (key != "ArrowLeft" && key != "ArrowDown" && key != "ArrowRight" && key != "ArrowUp" && previouskey === "ArrowDown"){
                yplayer+=ys;
            }
            if (key != "ArrowLeft" && key != "ArrowDown" && key != "ArrowRight" && key != "ArrowUp" && previouskey === "ArrowRight"){
                xplayer+=xs;
            }
            if (key != "ArrowLeft" && key != "ArrowDown" && key != "ArrowRight" && key != "ArrowUp" && previouskey === "ArrowLeft"){
                xplayer-=xs;
            }
            if (looses === false) {
...
/* TO DO : ANIMATING BUTTON  + TRANSITION MENU + CHANGE AND ADAPT DIFFICULTY BY INCREASING ACL OR SPEED + MAKE SCORE BEGIN ON 0 + ANIMATION EVERYWHERE + ADD OBSTACLES FOR HARD LEVEL*/  
/* Bug list :
    - PUSH ARROW OUTSIDE THE GAME // does not matter now
*/